...
public class mainStudentRegistration {
 ...
 //================================= Option 1 View (Read) =================================
  ...
  public static StudentRegistration inputStudentRegistration() {
   ...
   StudentRegistration student = new StudentRegistration(name,gender, mobile, email, dateofbirth, countryofresidence, interest);
   return student;
  }
  public static void addStudentRegistration(ArrayList<StudentRegistration> StudentRegistrationList, StudentRegistration student) {
